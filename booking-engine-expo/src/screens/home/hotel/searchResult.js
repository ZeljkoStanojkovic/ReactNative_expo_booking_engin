...
class SearchResultC extends PureComponent {
    ...
    clickTab(index) {
        switch (index) {
            case 0:
                this.refs.sort.open(); break;
            case 1:
                Actions.HotelFilter(); break;
            case 2:
    ...
    clickItem(hotel) {
        ...
        this.props.actions.getHotelDetail(hotel.id, Global.searchToken)
        Actions.HotelDetail()
    }
    ...
    fetchMore(){
        ...
        if(pageInfoIndex[0] && pageInfoIndex[0].item.hasNextPage) {
            ...
            this.props.actions.searchHotelPageNext(searchPageData).then(()=>{
    ...
    renderHotelMap() {
        return (
            <HotelMapView
                ...
                onPress={(hotel, index) => this.clickItem(index)}
            />
        )
    }
    ...
    sortHotel(index) {
        ...
        this.props.actions.searchHotelPage(searchPageData)
    }
